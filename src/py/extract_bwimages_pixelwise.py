...
#	Program starts here...
print ("\nThis program extracts 2-D feature vectors from test B/W images patch size wise.\n")
...
print "Reading images and generating feature vectors from test data (this may take a while)..."
