...
print "Reading images and generating feature vectors from training data..."
calcPrereqTest(direct,directOtrain,1)

print "Done. Now readingimages and generating feature vectors from training data..."
calcPrereqTest(direct,directOtrain,2)

print "Featueres extracted successfully."
