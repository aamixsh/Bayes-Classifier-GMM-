...
if(choice=='o'):
	...
	if choiceIn==1:
		...
		directM="../../data/Output/GMM/Dataset 1/train_model"
		directO="../../data/Output/GMM/Dataset 1/test_results/"
	else:
		direct="../../data/Input/GMM/Dataset 2/A/test"
		directM="../../data/Output/GMM/Dataset 2/A/train_model"
		directO="../../data/Output/GMM/Dataset 2/A/test_results/"
